...
- Pull Request(PR) 생성 시: Firebase Hosting **preview 배포** 자동 실행
- main merge 시: Firebase Hosting **live 배포** 자동 실행
...
- **수동 firebase deploy**: 긴급 상황 전용 / 장애 복구용 / GitHub Actions 실패 시만 사용
