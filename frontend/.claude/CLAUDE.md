...
| 플랜 | 가격 | 핵심 기능 |
|------|------|----------|
| 라이트 | 4,000원 / 월 | 10가지 기록 + SAYU + 통계·합본 + 사진 + AI 비서실 통합 월 10회 무료 |
| 프리미엄 | 5,000원 / 월 | 라이트 모든 기능 + AI 비서실 각 에이전시 일 2회 / 월 40회 |
| 무료 체험 | 신규 가입 7일 | 프리미엄 전 기능 무제한 체험 |

손익분기점: 약 600명

> ⚠️ 구 정책(₩3,000 단일 / Flutter ₩4,000) outdated. 본 표가 단일 소스.
> 결제 시스템은 베타 무료 운영 중 — SubscriptionPage 결제 버튼 JSX 주석 처리 상태.
