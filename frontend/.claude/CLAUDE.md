...
| 결제 | PortOne → KG이니시스 카드 일반결제/카드 정기결제 |
...
| 플랜 | 가격 | 핵심 기능 |
|------|------|----------|
| 베이직 | 4,000원 / 월 | 10가지 기록 + SAYU + 통계·합본 + 사진 + AI 비서실 통합 월 10회 무료 |
| 프리미엄 | 6,000원 / 월 | 베이직 모든 기능 + AI 비서실 각 에이전시 일 2회 / 월 40회 |
| 무료 체험 | 신규 가입 7일 | 프리미엄 전 기능 무제한 체험 |

손익분기점: 약 600명

> ⚠️ 이전 가격 정책은 outdated. 본 표가 웹/PWA 기준 단일 소스.
> 결제 시스템은 PortOne/KG이니시스 카드 일반결제 및 카드 정기결제 기준.

PortOne Store ID: store-7a100ca2-8d9f-4015-8fdb-723e4527e2c2 (정식 결제 복원 시 사용)
