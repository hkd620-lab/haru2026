const sections = [
  ...
  },
  {
    title: '전액 환불',
    content:
      '결제일로부터 7일 이내이고, 유료 기능 이용 이력(기록 작성, AI 다듬기, 합본 출력, PDF 저장 등)이 없는 경우 전액 환불해 드립니다.',
  },
  {
    title: '부분 환불 (산정 기준)',
    content:
  ...
  },
  {
    ...
    content:
      '회사의 귀책사유로 서비스가 정상적으로 제공되지 못한 경우, 또는 표시·광고의 내용과 다르게 서비스가 제공된 경우에는 이용 기간과 관계없이 환불을 요청하실 수 있습니다.',
  },
  {
    title: '중복결제·과오금',
    content:
      '중복결제, 과오금 또는 결제 시스템 오류로 요금이 잘못 부과된 경우, 확인 후 해당 금액을 전액 환급해 드립니다.',
  },
  {
    title: '환불 방법 및 처리 기간',
    content:
