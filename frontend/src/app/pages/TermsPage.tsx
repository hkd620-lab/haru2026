const articles = [
  {
    title: '제1조 (목적)',
    content:
      '이 약관은 조이L허경대(이하 "운영자")가 제공하는 HARU 서비스(이하 "서비스") 이용에 관한 조건 및 절차를 규정함을 목적으로 합니다.',
  },
  {
    title: '제2조 (서비스 내용)',
    content:
      '운영자는 기록 작성, AI 다듬기(SAYU), 합본 출력 등 구독형 서비스를 제공합니다. 일부 기능은 프리미엄 구독 회원에게만 제공됩니다.',
  },
  {
    title: '제3조 (이용 요금)',
    content: [
  ...
  },
  {
    title: '제5조 (면책)',
    content:
      '운영자는 천재지변, 전쟁, 테러, 해킹, 통신장애 등 불가항력으로 인한 서비스 중단에 대해 책임을 지지 않습니다.',
  },
];
