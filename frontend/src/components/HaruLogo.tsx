...
const Icon = ({ type }: { type: string }) => {
  ...
  switch (type) {
    case 'diary':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><rect x="7" y="5" width="10" height="14" rx="1" {...iconProps} /><line x1="9" y1="9" x2="15" y2="9" {...iconProps} /><line x1="9" y1="12" x2="15" y2="12" {...iconProps} /><line x1="9" y1="15" x2="13" y2="15" {...iconProps} /></svg>);
    case 'essay':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><circle cx="12" cy="8" r="3" {...iconProps} /><path d="M12 11 L12 16 M9 14 L15 14" {...iconProps} /><circle cx="15" cy="7" r="1" fill="currentColor" stroke="none" /><circle cx="17" cy="6" r="0.8" fill="currentColor" stroke="none" /></svg>);
    case 'garden':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M12 18 L12 10" {...iconProps} /><path d="M12 10 C9 10 7 8 7 6 C7 6 9 7 12 7 C15 7 17 6 17 6 C17 8 15 10 12 10" {...iconProps} /><path d="M12 13 C10 13 8.5 11.5 8.5 10 C8.5 10 10 10.5 12 10.5 C14 10.5 15.5 10 15.5 10 C15.5 11.5 14 13 12 13" {...iconProps} /></svg>);
    case 'pet':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M6 10 L7 6 L9 8 L9 10" {...iconProps} /><path d="M18 10 L17 6 L15 8 L15 10" {...iconProps} /><circle cx="12" cy="12" r="5" {...iconProps} /><circle cx="10" cy="11" r="0.8" fill="currentColor" stroke="none" /><circle cx="14" cy="11" r="0.8" fill="currentColor" stroke="none" /><path d="M10 14 Q12 15 14 14" {...iconProps} /></svg>);
    case 'parenting':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><circle cx="12" cy="8" r="2.5" {...iconProps} /><path d="M12 10.5 L12 15 M10 12.5 L14 12.5" {...iconProps} /><circle cx="10" cy="8" r="0.7" fill="currentColor" stroke="none" /><circle cx="14" cy="8" r="0.7" fill="currentColor" stroke="none" /><path d="M10.5 9.5 Q12 10 13.5 9.5" {...iconProps} /></svg>);
    case 'travel':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M16 12 L18 12 L20 14 L18 14 L16 12" {...iconProps} /><path d="M8 11 L16 11 L16 13 L8 13 L6 14 L5 13 L6 12 L8 11 Z" {...iconProps} /><path d="M8 12 L4 10 L4 9 L8 11" {...iconProps} /></svg>);
    case 'mission':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><line x1="12" y1="6" x2="12" y2="18" {...iconProps} /><line x1="8" y1="10" x2="16" y2="10" {...iconProps} /><path d="M9 18 L15 18" {...iconProps} /></svg>);
    case 'report':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M7 6 C7 6 8 5 9 6 L10 7 C10 7 10 8 9 9 C9 9 9 11 13 15 C13 15 15 15 16 14 L17 13 C18 12 19 13 19 13 L18 16 C18 16 16 18 12 14 C8 10 6 8 6 8 L7 6" {...iconProps} /></svg>);
    case 'work':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M8 12 L8 18 L16 18 L16 12" {...iconProps} /><path d="M12 12 C9 12 7 10 7 8 C7 8 12 6 12 6 C12 6 17 8 17 8 C17 10 15 12 12 12" {...iconProps} /><line x1="6" y1="18" x2="18" y2="18" {...iconProps} /></svg>);
    case 'memo':
      return (<svg width="42" height="42" viewBox="0 0 24 24"><path d="M17 3 L21 7 L9 19 L5 20 L6 16 L17 3" {...iconProps} /><line x1="15" y1="5" x2="19" y2="9" {...iconProps} /></svg>);
    default:
      return null;
  }
};
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#F7F5F2' }}>
      ...
      <div className="flex flex-col items-center justify-center">
        <div key={animationKey} className="relative w-[380px] h-[380px] flex items-center justify-center">
          {grapeLayout.map((grape, index) => {
            const randomPos = getRandomPosition();
            const isCenterGrape = index === 5;
            return (
              <motion.div key={index} className={`absolute w-[78px] h-[78px] rounded-full flex items-center justify-center text-[#F7F5F2] ${isCenterGrape ? 'z-10' : ''}`}
                style={{ background: 'radial-gradient(circle at 35% 35%, #8B4789 0%, #6B3767 30%, #4a2349 60%, #2a1329 100%)', boxShadow: '0 10px 25px rgba(0,0,0,0.5), 0 5px 10px rgba(0,0,0,0.3), inset -6px -6px 15px rgba(0,0,0,0.6), inset 6px 6px 15px rgba(255,255,255,0.15)' }}
            ...
            <div className="flex items-center justify-center gap-1" style={{ marginBottom: '-12px' }}>
              {['H', 'A', 'R', 'U'].map((letter, index) => (
                <motion.span key={index} className="font-bold relative"
                  style={{ fontSize: '53px', backgroundImage: 'linear-gradient(135deg, #cc4400 0%, #ff6600 20%, #ffaa44 40%, #fff0dd 50%, #ffaa44 60%, #ff6600 80%, #cc4400 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', backgroundSize: '300% 100%', filter: 'drop-shadow(0 0 8px rgba(255,102,0,0.6)) drop-shadow(0 2px 4px rgba(0,0,0,0.5))' }}
