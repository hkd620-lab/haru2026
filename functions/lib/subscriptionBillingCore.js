...
function resolveInitialBillingStoredRequestSettlement(params) {
    var _a;
    const paymentStatus = normalizePaymentRequestStatus((_a = params.paymentData) === null || _a === void 0 ? void 0 : _a.status);
